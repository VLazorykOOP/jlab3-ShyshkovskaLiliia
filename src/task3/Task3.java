...
public class Task3 {
    ...
    public static void main(String[] args) {
        System.out.println("Демонстрація класів Money і Complex (інтерфейс)");
    ...
    public static Pair[] createObjectsArray() {
        ...
        for (int i = 0; i < count; i++) {
            System.out.println("\nОб'єкт " + (i + 1) + ":");
            System.out.println("1 - Money (гроші)");
            System.out.println("2 - Complex (комплексне число)");
    ...
    public static void demonstrateAllMethods() {
        ...
        // Money демонстрація
        System.out.println("\n--- КЛАС MONEY ---");
        System.out.println("Створення першого об'єкта Money:");
        Money money1 = createMoney();
        System.out.println("Створення другого об'єкта Money:");
        Money money2 = createMoney();

        System.out.println("\nРезультати операцій з Money:");
        ...
        // Complex демонстрація
        System.out.println("\n--- КЛАС COMPLEX ---");
        System.out.println("Створення першого об'єкта Complex:");
        Complex complex1 = createComplex();
        System.out.println("Створення другого об'єкта Complex:");
        Complex complex2 = createComplex();

        System.out.println("\nРезультати операцій з Complex:");
    ...
    public static void testErrorHandling() {
        ...
        try {
            System.out.println("\nСтворення об'єкта Money для тесту ділення на нуль:");
        ...
        try {
            System.out.println("\nСтворення об'єкта Complex для тесту ділення на нуль:");
        ...
        try {
            ...
            System.out.println("Спроба додати Money та Complex...");
            money.add(complex);
        } catch (IllegalArgumentException e) {
            System.out.println("Помилка: " + e.getMessage());
        }
